  ...
  const Footer = () => {
    ...
    return (
      <div className="app min-h-screen flex items-end justify-center font-poppins">
        <div className="py-8 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 bg-gray-300 text-slate-800 w-full p-4 relative">
          <div className="  ">
            ...
            <div className="infos text-gray-400 py-2">
              <span>Copyright © 2023 A Static Company. All rights reserved.</span>
            </div>
            <div className="footer-icons flex items-center space-x-3">
              {socialLinks.map((socialLink, index) => {
                ...
                return (
                  <Icon
                    key={`social-${index}`}
                    className="w-14 h-14 p-2 rounded-full bg-white hover:bg-white hover:text-slate-400 cursor-pointer"
                  />
                );
              })}
            </div>
